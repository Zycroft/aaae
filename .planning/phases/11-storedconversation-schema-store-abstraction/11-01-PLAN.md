...
2. Run: `node -e "const s = require('./shared/dist/index.js'); console.log(typeof s.StoredConversationSchema)"` from /Users/zycroft/Documents/PA/aaae — should print "object"
...
2. `node -e "const s = require('./shared/dist/index.js'); const sc = s.StoredConversationSchema.parse({ externalId: '00000000-0000-0000-0000-000000000001', sdkConversationRef: null, history: [] }); console.log(sc.userId, sc.status, sc.createdAt)"` from /Users/zycroft/Documents/PA/aaae — should print "anonymous active <ISO timestamp>"
3. Same parse with missing userId/tenantId/timestamps/status fields succeeds (backward compatibility confirmed)
4. Parsing with optional workflow fields omitted succeeds
</verification>
